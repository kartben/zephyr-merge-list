...
- `preview.py`: renders the page with mock data covering every PR state,
  for working on the UI without a GitHub token.
...
Then open http://localhost:8000 and re-run `./preview.py` after each change.
